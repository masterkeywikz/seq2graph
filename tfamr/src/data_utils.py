  ...
  if not gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(data_path, mode="r") as f:
      ...
      for line in f:
        ...
        tokens = tokenizer(line) if tokenizer else none_tokenizer(line)
        for w in tokens:
...
def prepare_wmt_data(data_dir, en_vocabulary_size, amr_vocabulary_size, amrseq_version):
